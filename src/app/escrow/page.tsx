      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Protected transactions with smart contract escrow, automated
            delivery confirmation, and decentralized dispute resolution via DAO
            voting.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 text-sm">
                Buyer pays into smart contract escrow. Funds are locked until
                delivery is confirmed or dispute is resolved.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 text-sm">
                Seller ships item with tracking. Buyer confirms delivery within
                48 hours or can initiate dispute.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 text-sm">
                Disputes resolved by DAO voting. Staked token holders vote on
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <div className="text-xs text-gray-500">
                            Reputation: {tx.buyer.reputation}/5
                          </div>
                        </div>
                        <div>
                          <div className="text-sm font-medium text-gray-700 mb-1">
                          ...
                          <div className="text-xs text-gray-500">
                            Reputation: {tx.seller.reputation}/5
                          </div>
                        </div>
                      </div>
                      ...
                      {tx.dispute && (
                        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                          ...
                          <div className="text-sm text-red-600">
                            Filed by: {tx.dispute.filedBy} on{" "}
                            {tx.dispute.filedAt}
                          </div>
                          ...
                          <div className="mt-3">
                            <div className="flex justify-between text-sm mb-1">
                              ...
                              <span>
                                {tx.dispute.daoVotes.total} votes cast
                              </span>
                            </div>
                            <Progress
                              value={
                                (tx.dispute.daoVotes.buyer /
                                  tx.dispute.daoVotes.total) *
                                100
                              }
                              className="mb-2"
                            />
                            <div className="flex justify-between text-xs text-gray-600">
                              <span>
                                Buyer: {tx.dispute.daoVotes.buyer} votes
                              </span>
                              <span>
                                Seller: {tx.dispute.daoVotes.seller} votes
                              </span>
                            </div>
                          </div>
                        </div>
        ...
        <div className="bg-white rounded-xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Buyer pays into smart contract escrow. Funds are securely locked
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Seller ships item with tracking number. Smart contract monitors
                delivery status.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Buyer confirms delivery within 48 hours. Funds automatically
                released to seller.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                If issues arise, DAO members vote on evidence to resolve
                disputes fairly.
              </p>
            </div>
          </div>
        ...
        <div className="text-center py-12 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Experience the most secure way to trade digital collectibles with
