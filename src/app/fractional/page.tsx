  ...
  const fractionalItems = [
    {
      ...
      verified: true,
      description:
        "Original Banksy artwork with full provenance and authentication.",
      benefits: [
    ...
    },
    {
      ...
      verified: true,
      description:
        "Rare vintage Rolex Daytona with Paul Newman dial, fully authenticated.",
      benefits: [
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Co-own high-value collectibles with other investors. Each share
            represents a portion of ownership with voting rights and profit
            sharing.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 text-sm">
                Multiple investors can own shares of high-value items, making
                expensive collectibles accessible to everyone.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 text-sm">
                Each share comes with voting rights on major decisions like
                selling, displaying, or maintaining the asset.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 text-sm">
                Shareholders receive proportional profits from sales,
                exhibitions, or licensing of the shared asset.
              </p>
            </CardContent>
          </Card>
        </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span>
                        {item.soldShares}/{item.totalShares} shares
                      </span>
                    </div>
                    <Progress
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div>
                        <span className="text-gray-500">Min Votes:</span>{" "}
                        {item.governance.minVotes}%
                      </div>
                      <div>
                        <span className="text-gray-500">Quorum:</span>{" "}
                        {item.governance.quorum}%
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                High-value collectibles are selected and professionally
                authenticated
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Shares are sold to investors who can trade them on the
                marketplace
              </p>
            </div>
        ...
        <div className="text-center py-12 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Join the future of collective ownership and make high-value
            collectibles accessible to everyone.
          </p>
