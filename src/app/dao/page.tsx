...
export default function DAOPage() {
  const [activeTab, setActiveTab] = useState<
    "proposals" | "disputes" | "governance" | "rewards"
  >("proposals");
  ...
  const proposals = [
    {
      ...
      description:
        "Proposal to increase escrow fees from 1% to 1.5% to improve dispute resolution funding.",
      category: "fee_change",
      status: "active",
    ...
    },
    {
      ...
      description:
        "Proposal to add Cartier as an official brand verification partner.",
    ...
    },
    {
      ...
      description:
        "Proposal to implement a new 3-tier dispute resolution system.",
      category: "governance",
      status: "passed",
  ...
  const disputes = [
    {
      ...
      description:
        "Buyer claims the Rolex Submariner is counterfeit based on serial number verification.",
      status: "voting",
      filedBy: "0x5555...6666",
      filedAt: "2024-01-20",
      evidence: [
    ...
    },
    {
      ...
      description:
        "Buyer claims the bag condition differs significantly from the listing description.",
      status: "resolved",
      filedBy: "0x7777...8888",
      filedAt: "2024-01-15",
      evidence: [
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Participate in governance, vote on proposals, resolve disputes, and
            earn rewards by contributing to the marketplace ecosystem.
          </p>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex justify-between text-xs text-gray-500">
                        <span>
                          ...
                          {(
                            (proposal.votes.for / proposal.votes.total) *
                            100
                          ).toFixed(1)}
                          %)
                        </span>
                        <span>
                          ...
                          {(
                            (proposal.votes.against / proposal.votes.total) *
                            100
                          ).toFixed(1)}
                          %)
                        </span>
                ...
                <Card key={dispute.id} className="overflow-hidden">
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4">
                      ...
                      <Progress
                        value={
                          (dispute.votes.buyer / dispute.votes.total) * 100
                        }
                        className="mb-2"
                      />
                      <div className="flex justify-between text-xs text-gray-500">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium">
                        {governanceStats.totalDisputes}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Resolved Disputes</span>
                      <span className="text-sm font-medium">
                        {governanceStats.resolvedDisputes}
                      </span>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          Earn tokens for resolving disputes
                        </div>
                      </div>
                      <div className="text-right">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium">
                        {userStats.earnedRewards} tokens
                      </span>
                    </div>
                  </div>
        ...
        <div className="text-center py-12 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Join the DAO and help shape the future of the digital collectibles
            marketplace while earning rewards.
          </p>
